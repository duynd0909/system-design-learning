...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setErrors({ general: error instanceof Error ? error.message : 'Invalid credentials' });
    } finally {
      setLoading(false);
    }
  }
      ...
      <Card>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-[var(--bg-secondary)] px-2 text-[var(--text-secondary)]">or continue with email</span>
          </div>
        </div>
